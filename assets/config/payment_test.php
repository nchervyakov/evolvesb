...
return [
    ...
    'errors' => [
        ...
        'rc_detail' => [
            0 => 'Успешно',
            1 => 'Позвонить эмитенту',
            4 => 'Изъять',
            5 => 'Не обслуживать',
            6 => 'Ошибка',
            7 => 'Изъять, особые условия',
            12 => 'Неправильная транзакция',
            13 => 'Неправильная сумма',
            14 => 'Нет такой карты',
            15 => 'Нет такого эмитента',
            30 => 'Ошибка формата данных',
            33 => 'Изъять, просроченная карта',
            34 => 'Подозрение в мошенничестве',
            35 => 'Изъять, позвонить в банк эквайер',
            36 => 'Изъять, ограничения по карте',
            37 => 'Изъять, позвонить в банк эквайер',
            38 => 'Изъять, превышение попыток ввода ПИНа',
            41 => 'Изъять, утерянная карта',
            43 => 'Изъять, украденная карта',
            51 => 'Недостаточно средств',
            54 => 'Срок действия истек',
            57 => 'Операция не разрешена держателю карты',
            58 => 'Операция не разрешена терминалу',
            59 => 'Подозрение в мошенничестве',
            61 => 'Превышение разрешенной суммы',
            62 => 'Ограниченная карта',
            65 => 'Превышение кол-ва операций',
            82 => 'Время проведения операции истекло',
            83 => 'Операция завершилась с ошибкой',
            91 => 'Эмитент недоступен',
            94 => 'Дублирование операции',
            95 => 'Авторизация не найдена',
            96 => 'Ошибка системы',
            -2 => 'Неправильный запрос',
            -3 => 'Ответ не получен или получен неправильный ответ',
            -8 => 'Ошибка в поле номера карты',
            -9 => 'Ошибка в поле срока действия карты',
            -11 => 'Ошибка в поле валюты',
            -12 => 'Ошибка в поле номера терминала',
            -15 => 'Неправильный RRN или INT_REF',
            -17 => 'В доступе отказано',
            -18 => 'Ошибка в поле описания CVC2',
            -19 => 'Аутентификация неудачна',
            -20 => 'Время обработки операции истекло',
        ],
    ]
];