...
<div class="row">
    <div class="col-xs-12">
        <p class="text-right buttons-row">
            <a href="/account/profile/edit" id="profile_link" class="button ladda-button" data-style="expand-right" style="width: auto;"><span class="ladda-label">Редактировать профиль</span></a>
        </p>
    </div>
</div>
