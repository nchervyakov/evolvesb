...
<div class="tab-pane active" id="step3">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-8">
                            <input class="form-control" id="fullName" name="fullName" required type="text"
                                   value="<?php $_($billingAddress['full_name'], 'fullName'); ?>">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-8">
                            <input class="form-control" required id="city" name="city" type="text"
                                   value="<?php $_($billingAddress['city'], 'city'); ?>">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-8">
                            <select class="form-control" id="country_id" data-validation="required" name="country_id">
                                <option value="RU" <?php echo $billingAddress['country_id'] == 'RU' ? 'selected' : ''; ?>>Россия</option>
                                <option value="EN" <?php echo $billingAddress['country_id'] == 'EN' ? 'selected' : ''; ?>>США</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
			...
			<div class="blockShadow bg-info">
				...
				<div class="row">
					<div class="col-xs-12" style="margin-bottom: 10px;">
						<button data-id="<?php echo $address->id?>" class="btn btn-block confirm-address ladda-button" data-token="<?php echo $this->getToken('checkout_step3'); ?>" data-style="expand-right" data-spinner-size="20"><span class="ladda-label">Выписать счёт на этот адрес</span></button>
					</div>
				</div>
				<div class="row">
					<div class="col-xs-6">
						...
						<div class="col-xs-6">
						<button data-id="<?php echo $address->id?>" class="btn btn-danger btn-block delete-address ladda-button small-button" data-size="xs" data-spinner-size="16" data-spinner-color="#666666" data-style="expand-right"><span class="ladda-label">Удалить</span></button>
					</div>
				</div>
            </div>
            <?php endforeach;?>
    ...
    <div class="row">
        ...
        <div class="col-xs-6">
            <button class="btn btn-default" onclick="window.location.href='/checkout/shipping'"><span class="glyphicon glyphicon-chevron-left"></span> Адрес доставки</button>
        </div>
        <div class="col-xs-6">
            <button id="btn_billing" class="btn pull-right ladda-button" data-target="#step3" data-toggle="tab" data-style="expand-left"><span class="ladda-label">Подтверждение <span class="glyphicon glyphicon-chevron-right icon-white"></span></span></button>
        </div>
    </div>
</div>
