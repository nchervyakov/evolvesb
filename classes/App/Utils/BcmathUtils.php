<?php
/**
 * Fetched from: @link[https://github.com/stormpat/CryptoCoin/blob/master/src/CryptoCoin/Utils/BcmathUtils.php]
 */
namespace App\Utils;
...
class BcmathUtils
{
    ...
    public static function bcxor($x, $y)
    {
        if (extension_loaded('bcmath'))
        {
            return self::_bcbitwise_internal($x, $y, 'App\\Utils\\BcmathUtils::_bcxor');
        }
        else
        {
            throw new \ErrorException("Please install BCMATH");
